export default function Footer() {
  return (
    <footer className="bg-[#2b4b54] text-white pt-10">
        ...
        <div className="space-y-7 ml-50">
          ...
          <div className="mt-4">
            <input
              ...
              className="bg-white w-90 p-3  text-black "
            /><br /> <br />
            <button className="bg-[#f7c17b] px-10 py-3  hover:bg-white]">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className=" bg-white text-center text-gray-800 mt-8 p-10">
        <p>Copyright © 2019 All Rights Reserved By. Free HTML Templates</p><br />
