...
export default function Hero() {
  return (
    <section className="bg-[#ffffff] text-white  pb-20  relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6">
        ...
        {/* Text */}
        <div className="md:w-1/2 space-y-4 bg-gray-700 mb-0 py-50 px-30 ">
      ...
      <div className="absolute  right-16 flex space-x-4 ">
        <button className="bg-[#f7c17b] hover:bg-[#2b4b54] p-5 ">
          <ChevronLeft className="w-7 h-7" />
        </button>
        <button className="bg-[#2b4b54] hover:bg-[#f7c17b] p-5 border border-white">
